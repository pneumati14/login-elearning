...
/**
 * Add a "Szolgáltatási költségek" sub-category under the Hardver product
...
final class Version20260610100000 extends AbstractMigration
{
    ...
    {
        return 'Add "Szolgáltatási költségek" sub-category under Hardver.';
    }
               ...
               AND NOT EXISTS (
                   SELECT 1 FROM product_subcategory s
                    WHERE s.category_id = c.id
                      AND s.name = 'Szolgáltatási költségek'
               )
            SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        $this->addSql(<<<'SQL'
            DELETE FROM product_subcategory
             WHERE name = 'Szolgáltatási költségek'
