...
export const usePublicationsStore = defineStore('publications', () => {
  ...
  async function uploadPublication(
    ...
    formData.append('titleAz', fields.title.az ?? '')
    formData.append('titleDe', fields.title.de ?? '')
    ...
    formData.append('topicDe', fields.topic.de ?? '')
    ...
    formData.append('authorDe', fields.author.de ?? '')
    ...
    formData.append('descriptionDe', fields.description.de ?? '')
